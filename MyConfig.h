...
/**
 * @def MY_ESPnow_secretKey 
 * @brief Secred key for ESPnow.
 */
#ifndef MY_ESPnow_secretKey
#define MY_ESPnow_secretKey {0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF}
#endif
