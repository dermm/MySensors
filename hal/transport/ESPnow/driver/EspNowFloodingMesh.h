...
void espNowFloodingMesh_send(uint8_t* msg, int size, int ttl=0, int tryCount=1); //Max message length is 236byte
...
bool espNowFloodingMesh_syncTimeAndWait(int timeoutMs=3000, int tryCount=3);
